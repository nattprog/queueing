...
vehicles__refuelTime__rands = floor(1+refuelTime__RANGE__MULTIPLIER*callRand(1,numOfVehicles));
...
vehicles__interArrivalTime__rands = [0, floor(1+interArrivalTime__RANGE__MULTIPLIER*callRand(1,numOfVehicles-1))];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
vehicles__petrolType__rands = floor(1+petrolType__RANGE__MULTIPLIER*callRand(1,numOfVehicles));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Creating: vehicles__litres__rands (list of randomised values for getting the litres)

% randomised inter arrival time from 1 to petrolType__RANGE__MULTIPLIER
vehicles__litres__rands = floor(1+litres__RANGE__MULTIPLIER*callRand(1,numOfVehicles));
