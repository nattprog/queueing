...
disp('---------------------------------------------------------------------------------------')
disp('| Vehicle number | RandNum for inter-arrival time | Inter-arrival time | Arrival time |')
disp('---------------------------------------------------------------------------------------')
for i = 1:numOfVehicles
    fprintf('| %14.0f | %30.0f | %18.0f | %12.0f |\n', i,  [vehicles__interArrivalTime__rands(i) vehicles__interArrivalTime(i) vehicles__arrivalTime(i)])
end
disp('---------------------------------------------------------------------------------------')
